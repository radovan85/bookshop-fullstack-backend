...
public class CorsHandler implements CorsConfigurationSource{
	...
	public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
		...
		returnValue.setAllowedHeaders(Arrays.asList("Access-Control-Allow-Headers","Access-Control-Allow-Origin","Access-Control-Request-Method", "Access-Control-Request-Headers","Origin","Cache-Control", "Content-Type", "Authorization"));
